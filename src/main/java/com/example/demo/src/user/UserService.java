...
public class UserService {
    ...
    public String getKaKaoAccessToken(String code) throws BaseException {
        ...
        try{
            ...
            sb.append("&client_id=300aad331203ba92d868f6ac8e6c5bee"); // TODO REST_API_KEY 입력
            sb.append("&redirect_uri=https://prod.wanted-a.online/users/oauth"); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
